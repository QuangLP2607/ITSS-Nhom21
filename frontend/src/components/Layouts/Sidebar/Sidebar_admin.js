        ...
        <div>
            ...
            <div className={`${styles['left-content']} ${showMenu ? styles['show'] : ''}`}>
                <ul className={styles['sitemap']} onClick={window.innerWidth <= 1000 ? handleHamburgerButtonClick : null}>
                    <li><NavLink to="/manage_item" className={location.pathname.includes('/manage_item') ? styles.active : ''}>Quản lí đồ ăn</NavLink></li>
                    <hr className={styles.separator} />
                    <li><NavLink to="/manage_recipe" className={location.pathname.includes('/manage_recipe') ? styles.active : ''}>Quản lí công thức nấu ăn</NavLink></li>
                    <hr className={styles.separator} />
                    <li><NavLink to="/manage_group" className={location.pathname.includes('/manage_group') ? styles.active : ''}>Quản lí nhóm</NavLink></li>
                    <hr className={styles.separator} />
